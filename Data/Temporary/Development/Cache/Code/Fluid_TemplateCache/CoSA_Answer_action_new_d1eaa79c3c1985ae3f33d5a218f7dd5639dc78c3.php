<?php
class FluidCache_CoSA_Answer_action_new_d1eaa79c3c1985ae3f33d5a218f7dd5639dc78c3 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments10['optionValueField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
...
$arguments35['optionValueField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
