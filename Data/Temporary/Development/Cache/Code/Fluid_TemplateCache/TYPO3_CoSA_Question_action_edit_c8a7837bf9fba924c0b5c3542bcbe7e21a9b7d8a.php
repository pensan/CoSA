<?php
class FluidCache_TYPO3_CoSA_Question_action_edit_c8a7837bf9fba924c0b5c3542bcbe7e21a9b7d8a extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1 = array();
$arguments1['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments22 = array();
$arguments22['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
