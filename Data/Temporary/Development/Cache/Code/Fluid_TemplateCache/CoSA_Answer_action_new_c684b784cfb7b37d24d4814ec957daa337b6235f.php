<?php
class FluidCache_CoSA_Answer_action_new_c684b784cfb7b37d24d4814ec957daa337b6235f extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments10['optionValueField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'text', $renderingContext);
...
$arguments35['optionValueField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'text', $renderingContext);
