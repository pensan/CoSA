<?php
class FluidCache_TYPO3_CoSA_Room_action_load_2ce12fda23c035e73947948aaf81c9d508673185 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output38 .= '?version=3&amp;hl=en_US&amp;rel=0" type="application/x-shockwave-flash" width="418" height="230" allowscriptaccess="always" allowfullscreen="true">
		</embed>
	</object>
...
$output66 .= '?version=3&amp;hl=en_US&amp;rel=0" type="application/x-shockwave-flash" width="418" height="230" allowscriptaccess="always" allowfullscreen="true">
		</embed>
	</object>
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments121 = array();
$arguments121['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'videoUrl', $renderingContext);
...
$output120 .= '?version=3&amp;hl=en_US&amp;rel=0"></param>
		<param name="allowFullScreen" value="true"></param>
		<param name="allowscriptaccess" value="always"></param>
		<embed src="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
...
$output120 .= '?version=3&amp;hl=en_US&amp;rel=0" type="application/x-shockwave-flash" width="418" height="230" allowscriptaccess="always" allowfullscreen="true">
		</embed>
	</object>
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments149 = array();
$arguments149['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'videoUrl', $renderingContext);
...
$output148 .= '?version=3&amp;hl=en_US&amp;rel=0"></param>
		<param name="allowFullScreen" value="true"></param>
		<param name="allowscriptaccess" value="always"></param>
		<embed src="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
...
$output148 .= '?version=3&amp;hl=en_US&amp;rel=0" type="application/x-shockwave-flash" width="418" height="230" allowscriptaccess="always" allowfullscreen="true">
		</embed>
	</object>
