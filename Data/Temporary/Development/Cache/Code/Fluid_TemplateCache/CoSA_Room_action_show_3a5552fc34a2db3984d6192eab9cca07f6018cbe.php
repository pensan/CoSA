<?php
class FluidCache_CoSA_Room_action_show_3a5552fc34a2db3984d6192eab9cca07f6018cbe extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output4 .= '); height: 500px; width: 850px;">
		<div>
			<img src="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Uri\ResourceViewHelper
$arguments12 = array();
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments14 = array();
$arguments14['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'backgroundImage', $renderingContext);
...
$output34 .= '); height: 500px; width: 850px;">
		<div>
			<img src="';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Uri\ResourceViewHelper
$arguments42 = array();
