<?php
class FluidCache_CoSA_Answer_action_new_6f54344ef76549061766227819bb0fcc5ae03a2f extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments10['optionLabelField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
...
$arguments35['optionLabelField'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
