<?php
class FluidCache_CoSA_Answer_action_new_05ff4140fe3c8b3d0d95ec5c94cd6210f38ea863 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments10['options'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
$arguments10['optionValueField'] = 'text';
...
$arguments35['options'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'question.text', $renderingContext);
$arguments35['optionValueField'] = 'text';
