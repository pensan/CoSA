...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class InterestRepository extends InterestRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Domain\Repository\InterestRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Domain\Repository\InterestRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Domain\Repository\InterestRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Domain\Repository\InterestRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Domain_Repository_InterestRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7173      