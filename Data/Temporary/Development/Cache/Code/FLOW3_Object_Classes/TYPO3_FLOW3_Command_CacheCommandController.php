...
class CacheCommandController extends CacheCommandController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Command\CacheCommandController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Command\CacheCommandController', $this);
		parent::__construct();
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->injectLockManager(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Core\LockManager'));
		$this->injectReflectionService(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Reflection\ReflectionService'));
	}
}
#0             %CLASS%TYPO3_FLOW3_Command_CacheCommandController %CLASS%TYPO3_FLOW3_MVC_Controller_CommandController11097     