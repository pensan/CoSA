...
class RoomRepository extends RoomRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\CoSA\Domain\Repository\RoomRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\CoSA\Domain\Repository\RoomRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\CoSA\Domain\Repository\RoomRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\CoSA\Domain\Repository\RoomRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_CoSA_Domain_Repository_RoomRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7183      