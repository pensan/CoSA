...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class ObjectPathMappingRepository extends ObjectPathMappingRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\MVC\Web\Routing\ObjectPathMappingRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\MVC\Web\Routing\ObjectPathMappingRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Web\Routing\ObjectPathMappingRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Web\Routing\ObjectPathMappingRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_Web_Routing_ObjectPathMappingRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7280      