...
class TransientSession extends TransientSession_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Session\TransientSession') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Session\TransientSession', $this);
	}
	 ...
	 */
	 public function start() {
		...
		try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'start', $methodArguments);
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'start', $methodArguments, NULL, $result);
				...
				if (!$afterAdviceInvoked) {
					$advices = $this->FLOW3_AOP_Proxy_targetMethodsAndGroupedAdvices['start']['TYPO3\FLOW3\AOP\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'start', $methodArguments, NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
	 ...
	 */
	 public function resume() {
		...
		try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'resume', $methodArguments);
					$result = $this->FLOW3_AOP_Proxy_invokeJoinPoint($joinPoint);

					$advices = $this->FLOW3_AOP_Proxy_targetMethodsAndGroupedAdvices['resume']['TYPO3\FLOW3\AOP\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'resume', $methodArguments, NULL, $result);
					$afterAdviceInvoked = TRUE;
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				...
				if (!$afterAdviceInvoked) {
					$advices = $this->FLOW3_AOP_Proxy_targetMethodsAndGroupedAdvices['resume']['TYPO3\FLOW3\AOP\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'resume', $methodArguments, NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
	 ...
	 public function destroy() {
		...
		$result = parent::destroy();
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'destroy', $methodArguments);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	 ...
	 public function renewId() {
		...
		$result = parent::renewId();
			...
			try {
					...
					$adviceChain->rewind();
					$result = $adviceChain->proceed(new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'renewId', $methodArguments, $adviceChain));
...
#0             %CLASS%TYPO3_FLOW3_Session_TransientSession15042     