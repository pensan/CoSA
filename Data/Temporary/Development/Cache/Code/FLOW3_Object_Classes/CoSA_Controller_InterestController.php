...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class InterestController extends InterestController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\InterestController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\InterestController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\InterestController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\InterestController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->interestRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Repository\InterestRepository');
...
#0             %CLASS%CoSA_Controller_InterestController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8113      