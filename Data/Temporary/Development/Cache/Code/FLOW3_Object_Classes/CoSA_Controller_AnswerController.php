...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class AnswerController extends AnswerController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\AnswerController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\AnswerController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\AnswerController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\AnswerController', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Controller_AnswerController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8093      