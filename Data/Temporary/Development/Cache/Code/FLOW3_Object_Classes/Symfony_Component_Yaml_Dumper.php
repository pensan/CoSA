...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Dumper extends Dumper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\Yaml\Dumper');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\Yaml\Dumper', $propertyName, 'transient')) continue;
...
#0             %CLASS%Symfony_Component_Yaml_Dumper6273      