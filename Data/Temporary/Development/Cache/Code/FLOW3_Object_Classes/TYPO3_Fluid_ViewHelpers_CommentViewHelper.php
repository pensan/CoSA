...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class CommentViewHelper extends CommentViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\CommentViewHelper', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_Fluid_ViewHelpers_CommentViewHelper %CLASS%TYPO3_Fluid_Core_ViewHelper_AbstractViewHelper6711      