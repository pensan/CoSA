...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class CollectionConverter extends CollectionConverter_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Property\TypeConverter\CollectionConverter') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Property\TypeConverter\CollectionConverter', $this);
	}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Property\TypeConverter\CollectionConverter');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Property\TypeConverter\CollectionConverter', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Property_TypeConverter_CollectionConverter %CLASS%TYPO3_FLOW3_Property_TypeConverter_AbstractTypeConverter6915      