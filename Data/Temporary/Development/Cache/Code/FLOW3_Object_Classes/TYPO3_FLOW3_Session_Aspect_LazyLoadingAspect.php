...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 * @TYPO3\FLOW3\Annotations\Aspect
	 * @TYPO3\FLOW3\Annotations\Introduce(pointcutExpression="filter(TYPO3\FLOW3\Session\Aspect\SessionObjectMethodsPointcutFilter)", interfaceName="TYPO3\FLOW3\Session\Aspect\LazyLoadingProxyInterface")
	 * @TYPO3\FLOW3\Annotations\Scope("singleton")
	 */
class LazyLoadingAspect extends LazyLoadingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Session\Aspect\LazyLoadingAspect') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Session\Aspect\LazyLoadingAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Session\Aspect\LazyLoadingAspect');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Session\Aspect\LazyLoadingAspect', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->systemLogger = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Log\SystemLoggerInterface');
	}
}
#0             %CLASS%TYPO3_FLOW3_Session_Aspect_LazyLoadingAspect7621      