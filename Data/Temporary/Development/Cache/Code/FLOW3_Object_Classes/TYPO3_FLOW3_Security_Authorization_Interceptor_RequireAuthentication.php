...
class RequireAuthentication extends RequireAuthentication_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\Interceptor\RequireAuthentication') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Interceptor\RequireAuthentication', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_Interceptor_RequireAuthentication7701      