...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class PlayerController extends PlayerController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\PlayerController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\PlayerController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\PlayerController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\PlayerController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->playerRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Repository\PlayerRepository');
...
#0             %CLASS%CoSA_Controller_PlayerController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8217      