...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class QuestionController extends QuestionController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\QuestionController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\QuestionController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\QuestionController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\QuestionController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->answerRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Repository\AnswerRepository');
...
#0             %CLASS%CoSA_Controller_QuestionController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8240      