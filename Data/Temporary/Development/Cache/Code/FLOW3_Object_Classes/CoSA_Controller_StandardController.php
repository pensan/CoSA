...
class StandardController extends StandardController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\StandardController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\StandardController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\StandardController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\StandardController', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Controller_StandardController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController7982      