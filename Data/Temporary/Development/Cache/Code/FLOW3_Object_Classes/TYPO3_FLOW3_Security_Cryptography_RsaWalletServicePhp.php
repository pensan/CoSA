...
class RsaWalletServicePhp extends RsaWalletServicePhp_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\RsaWalletServicePhp') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\RsaWalletServiceInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Cryptography_RsaWalletServicePhp8069      