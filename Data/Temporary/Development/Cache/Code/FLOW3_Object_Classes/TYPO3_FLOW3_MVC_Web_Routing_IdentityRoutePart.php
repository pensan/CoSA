...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class IdentityRoutePart extends IdentityRoutePart_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\Web\Routing\IdentityRoutePart');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\Web\Routing\IdentityRoutePart', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->objectPathMappingRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\MVC\Web\Routing\ObjectPathMappingRepository');
	}
}
#0             %CLASS%TYPO3_FLOW3_MVC_Web_Routing_IdentityRoutePart %CLASS%TYPO3_FLOW3_MVC_Web_Routing_DynamicRoutePart %CLASS%TYPO3_FLOW3_MVC_Web_Routing_AbstractRoutePart7013      