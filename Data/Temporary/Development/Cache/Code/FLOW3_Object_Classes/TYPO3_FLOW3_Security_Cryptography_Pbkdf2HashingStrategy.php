...
class Pbkdf2HashingStrategy extends Pbkdf2HashingStrategy_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\Pbkdf2HashingStrategy') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\Pbkdf2HashingStrategy', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\Pbkdf2HashingStrategy') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\PasswordHashingStrategyInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Cryptography_Pbkdf2HashingStrategy9647      