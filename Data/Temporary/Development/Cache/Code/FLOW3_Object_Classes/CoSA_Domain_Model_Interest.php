...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Interest extends Interest_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface, \TYPO3\FLOW3\Persistence\Aspect\PersistenceMagicInterface {
		...
		$this->FLOW3_AOP_Proxy_buildMethodsAndAdvicesArray();
			...
			if (isset($this->FLOW3_AOP_Proxy_methodIsInAdviceMode['__construct'])) {
				...
				try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'CoSA\Domain\Model\Interest', '__construct', $methodArguments);
	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'CoSA\Domain\Model\Interest', '__clone', $methodArguments);
					$result = $this->FLOW3_AOP_Proxy_invokeJoinPoint($joinPoint);

					$advices = $this->FLOW3_AOP_Proxy_targetMethodsAndGroupedAdvices['__clone']['TYPO3\FLOW3\AOP\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'CoSA\Domain\Model\Interest', '__clone', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	...
	$reflectedClass = new \ReflectionClass('CoSA\Domain\Model\Interest');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Domain\Model\Interest', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Domain_Model_Interest %CLASS%_TYPO3_FLOW3_Persistence_Aspect_PersistenceMagicInterface11508     