...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class RoomController extends RoomController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Controller\RoomController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Controller\RoomController', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Controller\RoomController');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Controller\RoomController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectSettings(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\FLOW3\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'CoSA'));
		$this->roomRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Repository\RoomRepository');
		$this->questionRepository = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Repository\QuestionRepository');
		$this->adventureSession = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('CoSA\Domain\Service\AdventureSession');
...
#0             %CLASS%CoSA_Controller_RoomController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8328      