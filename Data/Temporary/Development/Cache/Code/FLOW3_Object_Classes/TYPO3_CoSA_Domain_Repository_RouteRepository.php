...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class RouteRepository extends RouteRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\CoSA\Domain\Repository\RouteRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\CoSA\Domain\Repository\RouteRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\CoSA\Domain\Repository\RouteRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\CoSA\Domain\Repository\RouteRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_CoSA_Domain_Repository_RouteRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7191      