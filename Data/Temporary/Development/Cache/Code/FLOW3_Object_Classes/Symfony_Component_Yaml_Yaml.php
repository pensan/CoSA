...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Yaml extends Yaml_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\Yaml\Yaml');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\Yaml\Yaml', $propertyName, 'transient')) continue;
...
#0             %CLASS%Symfony_Component_Yaml_Yaml6265      