...
class Package extends Package_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'CoSA\Package') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Package', $this);
	...
	$reflectedClass = new \ReflectionClass('CoSA\Package');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Package', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Package %CLASS%TYPO3_FLOW3_Package_Package7576      