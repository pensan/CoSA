...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class CommandArgumentDefinition extends CommandArgumentDefinition_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[1])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $required in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\MVC\CLI\CommandArgumentDefinition');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\MVC\CLI\CommandArgumentDefinition', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_MVC_CLI_CommandArgumentDefinition7889      