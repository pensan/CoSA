...
class AccountRepository extends AccountRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Security\AccountRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\AccountRepository', $this);
		parent::__construct();
...
#0             %CLASS%TYPO3_FLOW3_Security_AccountRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7151      