...
class Package extends Package_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\Yaml\Package');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\Yaml\Package', $propertyName, 'transient')) continue;
...
#0             %CLASS%Symfony_Component_Yaml_Package %CLASS%TYPO3_FLOW3_Package_Package7572      