...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class AnswerRepository extends AnswerRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Domain\Repository\AnswerRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Domain\Repository\AnswerRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Domain\Repository\AnswerRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Domain\Repository\AnswerRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Domain_Repository_AnswerRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7157      