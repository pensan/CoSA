...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Parser extends Parser_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\Yaml\Parser');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\Yaml\Parser', $propertyName, 'transient')) continue;
...
#0             %CLASS%Symfony_Component_Yaml_Parser6588      