...
class PackageManager extends PackageManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Package\PackageManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\PackageManager', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Package\PackageManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Package\PackageManagerInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Package_PackageManager7673      