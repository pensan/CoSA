...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class QuestionRepository extends QuestionRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Domain\Repository\QuestionRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Domain\Repository\QuestionRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Domain\Repository\QuestionRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Domain\Repository\QuestionRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Domain_Repository_QuestionRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7173      