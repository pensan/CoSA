...
class FilterFirewall extends FilterFirewall_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\FilterFirewall') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\FilterFirewall', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\FilterFirewall') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\FirewallInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_FilterFirewall9387      