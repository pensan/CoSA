...
class AccessDecisionVoterManager extends AccessDecisionVoterManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\AccessDecisionVoterManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\AccessDecisionVoterManager', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\AccessDecisionVoterManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\AccessDecisionManagerInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_AccessDecisionVoterManager13069     