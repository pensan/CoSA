...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class LockManager extends LockManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Core\LockManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Core\LockManager', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Core\LockManager');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Core\LockManager', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_FLOW3_Core_LockManager7247      