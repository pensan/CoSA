...
class AuthenticationController extends AuthenticationController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authentication\Controller\AuthenticationController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authentication\Controller\AuthenticationController', $this);
		parent::__construct();
...
#0             %CLASS%TYPO3_FLOW3_Security_Authentication_Controller_AuthenticationController %CLASS%TYPO3_FLOW3_MVC_Controller_ActionController %CLASS%TYPO3_FLOW3_MVC_Controller_AbstractController8528      