...
class PersistenceManager extends PersistenceManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Persistence\PersistenceManagerInterface', $this);
	 ...
	 protected function emitAllObjectsPersisted() {
		...
		$result = parent::emitAllObjectsPersisted();
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', 'emitAllObjectsPersisted', $methodArguments);
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Doctrine\PersistenceManager', 'emitAllObjectsPersisted', $methodArguments, NULL, $result);
...
#0             %CLASS%TYPO3_FLOW3_Persistence_Doctrine_PersistenceManager %CLASS%TYPO3_FLOW3_Persistence_AbstractPersistenceManager13668     