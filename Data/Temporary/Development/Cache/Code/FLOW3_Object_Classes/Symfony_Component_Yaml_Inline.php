...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Inline extends Inline_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\Yaml\Inline');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\Yaml\Inline', $propertyName, 'transient')) continue;
...
#0             %CLASS%Symfony_Component_Yaml_Inline6273      