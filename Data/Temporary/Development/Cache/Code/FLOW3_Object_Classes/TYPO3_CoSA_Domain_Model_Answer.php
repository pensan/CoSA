...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class Answer extends Answer_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface, \TYPO3\FLOW3\Persistence\Aspect\PersistenceMagicInterface {
		...
		$this->FLOW3_AOP_Proxy_buildMethodsAndAdvicesArray();
			...
			if (isset($this->FLOW3_AOP_Proxy_methodIsInAdviceMode['__construct'])) {
				...
				try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\CoSA\Domain\Model\Answer', '__construct', $methodArguments);
	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\CoSA\Domain\Model\Answer', '__clone', $methodArguments);
					$result = $this->FLOW3_AOP_Proxy_invokeJoinPoint($joinPoint);

					$advices = $this->FLOW3_AOP_Proxy_targetMethodsAndGroupedAdvices['__clone']['TYPO3\FLOW3\AOP\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\FLOW3\AOP\JoinPoint($this, 'TYPO3\CoSA\Domain\Model\Answer', '__clone', $methodArguments, NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
	...
	$reflectedClass = new \ReflectionClass('TYPO3\CoSA\Domain\Model\Answer');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\CoSA\Domain\Model\Answer', $propertyName, 'transient')) continue;
...
#0             %CLASS%TYPO3_CoSA_Domain_Model_Answer %CLASS%_TYPO3_FLOW3_Persistence_Aspect_PersistenceMagicInterface11534     