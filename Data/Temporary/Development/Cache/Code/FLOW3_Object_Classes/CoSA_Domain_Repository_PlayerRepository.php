...
use TYPO3\FLOW3\Annotations as FLOW3;
	 ...
	 */
class PlayerRepository extends PlayerRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'CoSA\Domain\Repository\PlayerRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('CoSA\Domain\Repository\PlayerRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('CoSA\Domain\Repository\PlayerRepository');
	...
	foreach($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('CoSA\Domain\Repository\PlayerRepository', $propertyName, 'transient')) continue;
...
#0             %CLASS%CoSA_Domain_Repository_PlayerRepository %CLASS%TYPO3_FLOW3_Persistence_Repository7157      