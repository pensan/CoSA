...
class Apache2AccessRestrictionPublisher extends Apache2AccessRestrictionPublisher_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Security\Authorization\Resource\Apache2AccessRestrictionPublisher') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Authorization\Resource\AccessRestrictionPublisherInterface', $this);
...
#0             %CLASS%TYPO3_FLOW3_Security_Authorization_Resource_Apache2AccessRestrictionPublisher7907      